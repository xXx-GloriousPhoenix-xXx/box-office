...
namespace BoxOffice.BLL.Interfaces
{
    public interface IBookingService
    {
        ...
        Task<bool> ExtendBookingAsync(string bookingToken, int additionalHours, CancellationToken ct = default);
        Task<IEnumerable<BookingDto>> GetActiveBookingsAsync(CancellationToken ct = default);
    }
}